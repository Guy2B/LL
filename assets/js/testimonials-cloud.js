(() => {
  ...
  function render() {
    ...
    track.innerHTML = items.map((item) => `
      <article class="testimonial-card cloud-testimonial-card">
    ...
    // Slider robuste, même si l'ancien CSS change.
  ...
  async function loadTestimonials() {
    if (!API_URL || API_URL === PLACEHOLDER_API) {
      ...
      render();
      setStatus("Kundenstimmen-Cloud ist noch nicht verbunden. URL Google Apps Script in index.html eintragen.", "warn");
      return;
    }
    ...
    try {
      ...
      render();
      setStatus("Kundenstimmen konnten gerade nicht geladen werden.", "warn");
    }
  }
